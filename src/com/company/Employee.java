...
public class Employee extends Job {
    ...
    public Employee(int employeeId, String employeeName, String surname, String address, String jobName, int salary) {
    ...
    public Employee(int companyId, String companyName, String foundationDate, String jobName, int salary, int companyId1, int employeeId, String employeeName, String surname, String address, String jobName1, int salary1) {
